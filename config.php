<?php
define('DB_DATABASE','transport');// Database name
...
define('COMPANY_NAME','Tân Cảng Miền Trung');
define('COMPANY_NO','11111111');
define('COMPANY_ADD','KV8, Phường Hải Cảng, TP. Quy Nhơn, Tỉnh Bình Định');
?>
